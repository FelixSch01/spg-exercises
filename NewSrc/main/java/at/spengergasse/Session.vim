...
set incsearch
set ruler
set runtimepath=~/.vim,~/.vim/plugged/ale,~/.vim/plugged/nerdtree,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=10
set shiftwidth=4
set showcmd
set showmatch
...
silent only
silent tabonly
cd ~/Documents/Coding/IntellijProjects/newlesson/StringDemo-HangmanGame/src/main/java/at/spengergasse
...
badd +0 game/Hangman.java
badd +0 ensurer/Ensurer.java
badd +0 game/HangmanGame.java
argglobal
%argdel
$argadd game/Hangman.java
set stal=2
tabnew +setlocal\ bufhidden=wipe
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit game/Hangman.java
argglobal
setlocal keymap=
setlocal noarabic
...
normal! 09|
tabnext
edit ensurer/Ensurer.java
argglobal
balt game/Hangman.java
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
normal! 079|
tabnext
edit game/HangmanGame.java
argglobal
balt ensurer/Ensurer.java
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
